...
import com.example.qainfomate.Book;
import com.example.qainfomate.BookSale;
import com.example.qainfomate.Book_for_Sale;
...
public class Post_Book2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        categories.add("Book Category"); categories.add("Programming"); categories.add("Management"); categories.add("Biology");
        categories.add("Web Development"); categories.add("Networking"); categories.add("User Experience");
        ...
        post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Book_for_Sale bookfs = new Book_for_Sale(title.getText().toString(), author.getText().toString(), description.getText().toString(),spinner.getSelectedItem().toString(),url, Session.LiveSession.user.getStuID(), true);
